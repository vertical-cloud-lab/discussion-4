# Pink Heart with "HARDWARE" — Design

A text-only (ASCII) design for a pink paper heart with the word **HARDWARE**
written in ALL CAPS near the top of the heart.

> Color note: The construction paper used is **PINK**. Because this design must
> be text-only, the color is documented here rather than rendered.
...
There are four roles. Each person owns a distinct part of the build so the
sample can move smoothly from one to the next.

| Role       | Tool / Responsibility                | Task on this project                                                                 |
| ---------- | ------------------------------------ | ------------------------------------------------------------------------------------ |
